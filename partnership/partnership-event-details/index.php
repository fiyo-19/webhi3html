...
<body>
	<nav class="navbar navbar-expand-md" style="background-color: #FFF7E9 ;">
        ...
        <section class="partnership-details container-xl my-5">
           <div class="partnership-details-desc d-flex flex-column">
                <a href="../"><i class="fa-solid fa-chevron-left me-1"></i>Kembali</a>
               <h1 class="my-4 fw-bold text-start text-md-center" style="color: #FF731D;">Event Collaboration</h1>
               <h4 class="my-3 fw-bold" style="color: #174EA6">Persyaratan</h4>
                <ol>
                    <li>Lorem ipsum dolor sit, amet consectetur adipisicing elit. A in aliquid minima impedit ullam rem, nulla, soluta voluptatum ab? Omnis.</li>
                    <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora ad similique asperiores tenetur ab quasi quo animi fugit veritatis vero.</li>
                    <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic, delectus. Atque id eaque, error, cumque aut commodi explicabo facere iste.</li>
                    <li>Lorem ipsum dolor sit amet consectetur adipisicing, elit. Veritatis earum voluptatibus odio, beatae neque incidunt vitae sed et ipsum illum.</li>
                    <li>Lorem ipsum dolor sit amet, consectetur adipisicing, elit. Blanditiis quam distinctio delectus unde doloribus ea repudiandae in iste explicabo quia.</li>
                </ol>
               <h4 class="my-2 fw-bold" style="color: #174EA6">Link Form</h4>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae accusantium esse doloremque vero quasi unde velit cumque saepe? Doloremque fugit repellat rem fuga temporibus dignissimos, dolorem excepturi eos, harum aliquid.</p>
               <h4 class="my-2 fw-bold" style="color: #174EA6">Hubungi Kami</h4>
                <a href="#">houseilmu@gmail.com</a>
           </div>
        </section>
