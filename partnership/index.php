...
<head>
        ...
        <title>Partnership | House Ilmu Indonesia</title>
	...
	<nav class="navbar navbar-expand-md" style="background-color: #FFF7E9 ;">
        ...
        <section class="partnership-title container-xl mt-5">
           <div class="partnership-title-container container-xl d-flex flex-column justify-content-center align-items-center">
               <h1 class="py-4 text-center">Kenapa Memilih Kami?</h1>
               <p class="text-center col-12 col-md-8">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p>
           </div>
        </section>

        <section class="partnership-list container-xl my-5">
            <div class="partnership-list-container container-xl d-flex flex-wrap justify-content-around align-items-start">
                <h1 class="col-12 py-4 text-center">Jenis Kolaborasi</h1>
                <div class="partnership-list-choice col-12 col-md-5 d-flex flex-column align-items-center py-4 my-2 px-4 px-md-0 rounded-4" style="background-color: #FF9900;">
                    <h1 class="py-1 mt-3 fw-bold" style="color: #1746A2;">Partnership</h1>
                    <p class="py-2 col-12 col-md-8">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p>
                    <a class="me-5 align-self-end" href="partnership-details/">Learn more...</a>
                </div>
                <div class="partnership-list-choice col-12 col-md-5 d-flex flex-column align-items-center py-4 my-2 px-4 px-md-0 rounded-4" style="background-color: #FF9900;">
                    <h1 class="py-1 mt-3 fw-bold" style="color: #1746A2;">Konten</h1>
                    <p class="py-2 col-12 col-md-8">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p>
                    <a class="me-5 align-self-end" href="partnership-konten-details/">Learn more...</a>
                </div>
                <div class="partnership-list-choice col-12 col-md-5 d-flex flex-column align-items-center py-4 my-2 px-4 px-md-0 rounded-4" style="background-color: #FF9900;">
                    <h1 class="py-1 mt-3 fw-bold" style="color: #1746A2;">Affiliate</h1>
                    <p class="py-2 col-12 col-md-8">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p>
                    <a class="me-5 align-self-end" href="partnership-affiliate-details/">Learn more...</a>
                </div>
                <div class="partnership-list-choice col-12 col-md-5 d-flex flex-column align-items-center py-4 my-2 px-4 px-md-0 rounded-4" style="background-color: #FF9900;">
                    <h1 class="py-1 mt-3 fw-bold text-center" style="color: #1746A2;">Event Collaboration</h1>
                    <p class="py-2 col-12 col-md-8">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p>
                    <a class="me-5 align-self-end" href="partnership-event-details/">Learn more...</a>
                </div>
            </div>
        </section>
...
<!-- <h1 class="py-3">2. Konten</h1>
                    <p class="py-2 col-12 col-md-8">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p>
                    <h1 class="py-3">3. Affiliate</h1>
                    <p class="py-2 col-12 col-md-8">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p> -->