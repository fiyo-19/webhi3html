...
<body>
    ...
    <section class="available container-xl mt-5">
    	<div class="back d-inline">
            <a href="../../#career-info"><i class="fa-solid fa-chevron-left"></i> Back</a>
        </div>
    	<div class="available-container container-xl d-flex flex-column justify-content-center align-items-center">
    		...
    		<div class="apply-info container-xl d-flex flex-column justify-content-center align-items-center">
    			<div class="vice container-xl d-flex flex-wrap justify-content-center justify-content-md-start align-items-center text-center text-md-start p-3">
    				<h4 class="ps-4 col-12 col-md-7 text-light">Vice President</h4>
    				<a class="details col-5 col-md-2 p-2 mx-1 rounded-3 text-center" href="vice-details/">Details</a>
    				<a class="apply col-5 col-md-2 p-2 mx-1 rounded-3 text-center" href="#">Daftar</a>
    			</div>
    			<div class="staff container-xl d-flex flex-wrap justify-content-center justify-content-md-start align-items-center text-center text-md-start p-3">
    				<h4 class="ps-4 col-12 col-md-7 text-light">Staff</h4>
    				<a class="details col-5 col-md-2 p-2 mx-1 rounded-3 text-center" href="staff-details/">Details</a>
    				<a class="apply col-5 col-md-2 p-2 mx-1 rounded-3 text-center" href="#">Daftar</a>
    			</div>
    		</div>
    	</div>
